...
import { createRoom, deleteRoom, joinRoom, getRoomMembers, getUserRooms, getRoomById } from "./room-controller";
...
router.get("/:room_id", protectedRoute, isMember, getRoomById)
